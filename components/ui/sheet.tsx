    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Default width classes only if no width is specified in className prop
          !className?.includes('w-') && side === "right" && "w-3/4 sm:max-w-sm",
          !className?.includes('w-') && side === "left" && "w-3/4 sm:max-w-sm",
          className
        )}
        {...props}
      >
